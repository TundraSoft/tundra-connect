 ...
 */
export type RefundRequestSchema = {
...
const _refundRequestSchema: BaseGuardian<RefundRequestSchema> = Guardian
  .object({
...
const _refundSchema: BaseGuardian<RefundSchema> = Guardian.object({
  id: Guardian.string(),
